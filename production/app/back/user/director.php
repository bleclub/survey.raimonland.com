 ...
 * php code///////////**********************************************************
 */
$title = 'จัดการทำเนียบผู้บริหาร';
$menu_user = "active";
$menu_director = "active";
$db = new database();
if($_SESSION[_ss . 'levelaccess'] != 'superadmin') { header('Location: '.$baseUrl.'/back/home'); } 

$sql_user = "select * from btview_user where groupNameEN='Director' or groupNameEN='Secretary-General of PACC' or groupNameEN='Deputy Secretary-General of PACC' order by managementOrder";
